...
impl ExpressionValue {
    ...
    /// Creates a value pair from two values, coercing untyped integers/floats to
    /// match the other operand's type. Used for range iteration to determine
    /// the common type between range bounds.
...
/// Used for range iteration to represent a pair of values with matching types.
