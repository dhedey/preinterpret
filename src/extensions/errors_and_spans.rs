...
pub(crate) trait SpanErrorExt {
    ...
    fn syntax_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
    ...
    fn type_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
    ...
    fn control_flow_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
    ...
    fn ownership_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
    ...
    fn assertion_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
    ...
    fn debug_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
    ...
    fn value_err<T, E: From<ExecutionError>>(&self, message: impl std::fmt::Display) -> Result<T, E> {
