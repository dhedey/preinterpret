...
impl Parse<Source> for SourceStreamInput {
...
impl HasSpanRange for SourceStreamInput {
...
impl Interpret for SourceStreamInput {
    fn interpret_into(
        self,
        ...
        match self {
            SourceStreamInput::Command(mut command) => {
                match command.output_kind() {
                    ...
                    CommandOutputKind::Stream => parse_as_stream_input(
                        command,
                        interpreter,
                        || {
            ...
            SourceStreamInput::ExplicitStream(group) => {
